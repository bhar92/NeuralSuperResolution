...
class SR_8x_TransformerNet(torch.nn.Module):
    def __init__(self):
        super(SR_8x_TransformerNet, self).__init__()
        ...
        self.in6 = torch.nn.InstanceNorm2d(64, affine=True)
        self.deconv4 = ConvLayer(64, 3, kernel_size=9, stride=1)
        # Non-linearities
...
class SR_4x_TransformerNet(torch.nn.Module):
    def __init__(self):
        super(SR_4x_TransformerNet, self).__init__()
        # Initial convolution layers
        self.conv1 = ConvLayer(3, 64, kernel_size=9, stride=1)
        self.in1 = torch.nn.InstanceNorm2d(64, affine=True)
        # Residual layers
